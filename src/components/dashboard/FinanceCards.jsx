...
const FinanceCards = () => {
  return (
    <div className="grid grid-cols-2 sm:grid-cols-4 gap-x-5 sm:gap-5 gap-y-2">
      <div className="mt-4 flex flex-col-reverse md:flex-row w-full items-start md:items-center justify-between rounded-xl border border-[#bdbdbd31] bg-[#2e2e2e] md:px-6  px-4 pt-4 pb-2">
        <div>
